...
<html>
<head>
	<title>Applications | e-Thesis</title>
		...
		<div class="row">
			<div class="col-md-2">
				<div class="sidebar content-box" style="display: block;">
					...
					echo SideMenu::getSideBarMenu(2, $role); ?>
				</div>
			</div>
			<div class="col-md-10">
				<div class="content-box-large">
					...
					<div class="panel-body">
						<div class="table-responsive">
							...
							} else if($user['role'] == User::ROLE_PROFESSOR) {
								include('views/applications_professor.php');
							} else if($user['role'] == User::ROLE_STUDENT) {
								include('views/applications_student.php');
							} ?>
						</div>
					</div>
				</div>
